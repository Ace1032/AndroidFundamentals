...
import com.example.heart2heart.data.Result
    ...
    fun login(username: String, password: String) {
        ...
        viewModelScope.launch {
            ...
            if (result is Result.Success) {
                ...
                _loginResult.value = LoginResult(success = LoggedInUserView(displayName = result.toString()))

            } else {
                _loginResult.value = LoginResult(error = R.string.login_failed)
                Log.d("LoginViewModel", "Unsuccessful")
            }
        }
